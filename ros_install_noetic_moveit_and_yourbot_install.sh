...
# The BSD License
# Copyright (c) 2021 lukasrobotics
...
echo "#######################################################################################################################"
echo ""
echo "Start ROS Noetic + Moveit + YourBot Installation, can take up to three or four hours"
...
echo "#######################################################################################################################"
echo "40"
sudo apt-get install -y pyinstaller
echo "#######################################################################################################################"
...
mv demo.launch /ws_moveit/src/panda_moveit_config/launch 

cd ~/ws_moveit/yourbot/yourbot_build
chmod u+x yourbot_build
ln -s ~/ws_moveit/yourbot/yourbot_build/yourbot_build ~/ws_moveit
cd ~/ws_moveit
chmod u+x yourbot_build
sudo reboot
